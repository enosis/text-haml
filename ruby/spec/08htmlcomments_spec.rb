...
#./text-haml/ruby/spec/
#Calling: spec --color 08htmlcomments_spec.rb -f s
#Authors:
...
#      - escape the / (or the resulting Html)
#      - or just add to outer comment
#     Defanging the Html: use '--' -> '- ' etc in the interior terminator.
