#!/usr/bin/env perl
#
#00ImplNotes_Code04-04.t
#./text-haml/t/wse
#
#Calling:  ./wse $ make code_4
#          ./wse $ perl 00ImplNotes_Code04-04.t
#
#Authors:
...
#================================================================
$tname = "ImplNotes Code 4-04: Motivation - Nex3 Issue 28 - Inconsistent indentation (as plaintext) WSE Haml";
$haml = Text::Haml->new( escape_html => 0,
                         preserve => ['pre', 'textarea', 'code'],
                         preformatted => ['ver', 'foo'],
                         oir => 'strict' );
